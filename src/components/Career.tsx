...
const articleInfo = [
  {
    ...
    projects: [
      ...
      {
        type: "Project",
        title: "산림 치유 코스 추천 알고리즘 및 서비스 어플리케이션 개발(웹앱)",
      },
      {
        type: "rnd",
        title:
          '"AI 분석 알고리즘을 활용한 침입자 분석, 실별, 대응하는 물리보안 시스템"',
      },
      {
        type: "rnd",
        title:
          '"디지털 콘텐츠 보호 및 관리를 위한 지능형 이미지 워터마킹 기반 브라우저 익스텐션 개발"',
      },
      {
        type: "rnd",
        title:
          '"MLOps/AI Multi Agent 기반 영상 콘텐츠 하이라이트 자동 생성 SW 개발"',
      },
    ],
